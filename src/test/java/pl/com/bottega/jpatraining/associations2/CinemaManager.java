...
public class CinemaManager {
    ...
    private <T> List<T> getReferences(List<Long> actorIds, Class<T> entityClass) {
        return actorIds.stream().map((id) -> entityManager.getReference(entityClass, id)).collect(Collectors.toList());
    }
}
